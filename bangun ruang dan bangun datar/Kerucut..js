...
const Kerucut = ({ navigation }) => {
    ...
    const fungsiKali = () => {
        ubahHasil(1/3 * 3.14 * angka1 * angka1 * angka2)
    }
    //luas permukaan
    ...
    const fungsiTambah = () => {
        ubahHasil1(3.14 * angka4 * angka4 + angka5)
    }
        ...
        <View style={{ flex: 1, justifyContent: "center", alignItems: "center", backgroundColor:"#6E6659" }} >
            <ScrollView>
                ...
                <View style={{
                    ...
                    {/* gambar */}
                    <Image source={require("./assets/kerucut.png")}
                    style={{alignSelf:"center", marginTop:15}}/>

                    {/* judul */}
                    <Text style={{fontSize:18, alignSelf:'center', fontWeight:'bold', marginTop:10}}>Kerucut</Text>
                </View>
                ...
                <View style={{ justifyContent: "center", alignItems: "center", backgroundColor: 'white', width: 350, borderRadius: 20, borderWidth: 2, height:400, marginTop:20, backgroundColor:'#E4C7A1' }}>
                    <Text style={{ fontSize: 25, color:'white', fontWeight:"bold" }}>Volume Kerucut</Text>
                    <Text style={{ fontSize: 20, marginBottom: 5, color:'white', fontWeight:"bold" }}>1/3 x 3,14 x r x r x t</Text>
                ...
                <View style={{ justifyContent: "center", alignItems: "center", backgroundColor: 'white', width: 350, borderRadius: 20, borderWidth: 2, height:400, marginTop:30, backgroundColor:'#E4C7A1' }}>
                    <Text style={{ fontSize: 25, marginBottom: 5, color:"white", fontWeight:'bold' }}>Luas Permukaan Kerucut</Text>
                    <Text style={{ fontSize: 20, marginBottom: 5, color:"white", fontWeight:'bold' }}>3,14 x r (r + s)</Text>
