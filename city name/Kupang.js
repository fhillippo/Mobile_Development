...
const Kupang= ({ navigation }) => {
    return(
        // penampung
        <View style={{flex:1, backgroundColor:"#687EFF"}}>

            {/* ini adalah judul */}
            <Text style={{color:"white", fontSize:28, fontWeight:"bold", alignSelf:"center", top:38}}>Kupang</Text>
            {/* underline */}
            ...
            style={{
                ...
                justifyContent:"center"
                    ...
                    <Text style={{fontSize:13, left:15, bottom:1}}>Gubernur Pertama : Viktor Laiskodat</Text>
                    <Text style={{fontSize:13, left:15, top:1}}>Lama Menjabat : 2018 - 2023</Text>
                </View>

            {/* profil gubernur */}
            <Image
            source={require('./assets/jos.png')}
            ...
            style={{
                ...
                justifyContent:"center"
                    ...
                    <Text style={{fontSize:13, left:15, bottom:1}}>Wakil Gubernur Pertama : Josef Nae Soi</Text>
