                          ...
                          <View style={{flex:1, alignContent:"center", justifyContent:"center"}}>
                              ...
                              style={{
                                  ...
                                  justifyContent:"center"
                                      ...
                                      {/* Text */}
                                      <Text style={{fontSize:14, fontWeight:"bold", left:16}}>Full Name :    Nurmahera</Text>
                              </View>
                          </View>
                      </View>
                          ...
                          <View style={{flex:1, alignContent:"center", justifyContent:"center"}}>
                              ...
                              style={{
                                  ...
                                  <View style={{flex:2, flexDirection:"row", alignItems:"center"}}>
                                      {/* Text */}
                                      <Text style={{fontSize:14, fontWeight:"bold", left:16}}>NickName :     Mahera</Text>
                                  </View>
                              </View>
                          </View>
                      </View>
                        ...
                        <View style={{flex:1, alignContent:"center", justifyContent:"center"}}>
                            ...
                            style={{
                              ...
                              justifyContent:"center"
                                  ...
                                  {/* Text */}
                                  <Text style={{fontSize:14, fontWeight:"bold", left:16}}>Birthday :     26 - 07 - 06</Text>
                            </View>
                        </View>
                      </View>
                        ...
                        <View style={{flex:1, alignContent:"center", justifyContent:"center"}}>
                            ...
                            style={{
                              ...
                              justifyContent:"center"
                                  ...
                                  {/* Text */}
                                  <Text style={{fontSize:14, fontWeight:"bold", left:16}}>Age :     17 Years Old</Text>
                            </View>
                        </View>
                      </View>
                        ...
                        <View style={{flex:1, alignContent:"center", justifyContent:"center"}}>
                            ...
                            style={{
                              ...
                              justifyContent:"center"
                                  ...
                                  {/* Text */}
                                  <Text style={{fontSize:14, fontWeight:"bold", left:16}}>Gender :     Female</Text>
                            </View>
                        </View>
                      </View>
