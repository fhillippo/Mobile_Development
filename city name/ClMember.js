                          ...
                          <View style={{flex:1, alignContent:"center", justifyContent:"center"}}>
                              ...
                              style={{
                                  ...
                                  justifyContent:"center"
                                      ...
                                      {/* Text */}
                                      <Text style={{fontSize:14, fontWeight:"bold", left:16}}>Full Name :    Clarissa Julieta</Text>
                              </View>
                          </View>
                      </View>
                          ...
                          <View style={{flex:1, alignContent:"center", justifyContent:"center"}}>
                              ...
                              style={{
                                  ...
                                  <View style={{flex:2, flexDirection:"row", alignItems:"center"}}>
                                      {/* Text */}
                                      <Text style={{fontSize:14, fontWeight:"bold", left:16}}>NickName :     Juliet</Text>
                                  </View>
                              </View>
                          </View>
                      </View>
                        ...
                        <View style={{flex:1, alignContent:"center", justifyContent:"center"}}>
                            ...
                            style={{
                              ...
                              justifyContent:"center"
                                  ...
                                  {/* Text */}
                                  <Text style={{fontSize:14, fontWeight:"bold", left:16}}>Birthday :     02 - 07 - 07</Text>
                            </View>
                        </View>
                      </View>
