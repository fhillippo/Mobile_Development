        ...
        <View style={{ flex: 1, justifyContent: "center", alignItems: "center", backgroundColor:"#6E6659" }} >
            <ScrollView>
                ...
                <View style={{
                    ...
                    {/* gambar */}
                    <Image source={require("./assets/limas.png")}
                    style={{alignSelf:"center", marginTop:15}}/>

                    {/* judul */}
                    <Text style={{fontSize:18, alignSelf:'center', fontWeight:'bold', marginTop:10}}>Limas</Text>
                </View>
                ...
                <View style={{ justifyContent: "center", alignItems: "center", backgroundColor: 'white', width: 350, borderRadius: 20, borderWidth: 2, height:400, marginTop:20, backgroundColor:'#E4C7A1' }}>
                    <Text style={{ fontSize: 25, color:'white', fontWeight:"bold" }}>Volume Limas</Text>
                    <Text style={{ fontSize: 20, marginBottom: 5, color:'white', fontWeight:"bold" }}>1/3 x LuasAlas x t</Text>

                    <TextInput style={{ width: 160, borderWidth: 3, borderColor: '#6E6659', borderRadius: 10, textAlign: "center", color: 'black' }} onChangeText={ubahAngka1} placeholder="Luas Alas"></TextInput>
                ...
                <View style={{ justifyContent: "center", alignItems: "center", backgroundColor: 'white', width: 350, borderRadius: 20, borderWidth: 2, height:400, marginTop:30, backgroundColor:'#E4C7A1' }}>
                    <Text style={{ fontSize: 25, marginBottom: 5, color:"white", fontWeight:'bold' }}>Luas Permukaan Limas</Text>
                    <Text style={{ fontSize: 20, marginBottom: 5, color:"white", fontWeight:'bold' }}>1/2 x Alas x t</Text>

                    <TextInput style={{ width: 160, borderWidth: 3, borderColor: '#6E6659', borderRadius: 10, textAlign: "center", color: 'black' }} onChangeText={ubahAngka4} placeholder="Alas"></TextInput>
